      ...
      <AppSidebar />      <SidebarInset>
            ...
            <div className="flex items-center gap-2">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator className="hidden md:block" />
                  <BreadcrumbItem>
                    <BreadcrumbPage>Departamente</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
        ...
        <div className="flex flex-1 flex-col gap-4 p-6 pt-0">
          <div className="flex flex-col space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">Gestionare Departamente</h1>
            <p className="text-muted-foreground">
              Administrează departamentele și structura organizațională a primăriei
            </p>
          </div>
